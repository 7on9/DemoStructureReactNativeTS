...
export default class ModalDropdown extends Component {
    ...
    onLayout = evt => {
        ...
        this.setState({ drowDownWidth: width })
        console.log('render modal:[', x, ',', y, ',', width, ',', height, ' ]')
    }
    render() {
        return (
    ...
    _renderButton() {
        const { disabled, accessible, children, textStyle, isShowButton } = this.props
        const { buttonText } = isShowButton ? this.state : ''
    ...
    _renderModal() {
        ...
        if (showDropdown && this._buttonFrame) {
            const wwww = this.state.drowDownWidth
            ...
            return (
                ...
                >
                    ...
                    >
                        <View style={{ ...styles.modal, width: wwww }}>
